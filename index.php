...
<body>
    <div id="header">
        ...
        <div class="header-mid">
            <ul class="dm1">
                ...
                <li><a href="./view/product.php">SẢN PHẨM</a>
                  <ul class="dm2">
                    <div class="dm">
                    <li><a href="">Cafe</a></li>
    ...
    <div class="header-content">
        <h1>DLV COFFEE HOUSE</h1>
        <i>It's a charming and inviting coffee shop that's perfect for a quick caffeine fix or a relaxing afternoon.</i>
    </div>
    </div>
    <div id="main">
        ...
        <div class="main-content">
            ...
            <p>"Đi cafe từ lâu đơn thuần không chỉ là đi cafe và còn là dịp gặp mặt và trò chuyện cùng bạn bè.
                 Tại DLV COFFEE HOUSE, chúng tôi trân trọng và đề cao giá trị kết nối giữa con người và trải nghiệm của khách hàng.
